...
def year():
    ...
    if requested_year != "1960":
        ...
        qualsum = ["there is no previous year for comparison"]*3

    def expectancyToColor(expectancy):
        return f"({round(255-((expectancy-50) * (255/50)), 2)},{round(255-((expectancy-50) * (255/50)), 2)}, 255)"
    ...
    legendvals  = [expectancyToColor(50), expectancyToColor(60), expectancyToColor(70), expectancyToColor(80), expectancyToColor(90) ,expectancyToColor(100)]
    print(legendvals)
    print(legendvals)
    return render_template('year.html', year = requested_year, colors = colors, colorstr = colorstr, expectancies = expectancies, qualsum = qualsum, legendvals = legendvals)
